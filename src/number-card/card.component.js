...
var count_helper_1 = require("../common/count/count.helper");
var CardComponent = (function () {
    ...
    CardComponent.prototype.startCount = function () {
        ...
        if (!this.initialized) {
            ...
            var decs = count_helper_1.decimalChecker(val);
            ...
            this.animationReq = count_helper_1.count(0, val, decs, 1, callback);
