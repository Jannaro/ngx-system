...
var injection_registery_service_1 = require("../../services/injection-registery.service");
var injection_service_1 = require("../../services/injection.service");
...
var TooltipService = (function (_super) {
    ...
    function TooltipService(injectionService) {
        ...
        _this.type = tooltip_component_1.TooltipContentComponent;
        return _this;
    }
